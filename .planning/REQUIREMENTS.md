...
- [x] **TREND-03**: User sees an updated, legible trend legend that correctly explains the new split-violin marks (recent vs prior halves, and any retained mean/actual-value marks), finalized via a reviewer copy round-trip.
